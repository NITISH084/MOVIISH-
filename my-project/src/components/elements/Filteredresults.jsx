    ...
    <div className="bg-black px-8">
      {moviepage && moviesearch && (
        <>
          ...
          <div className="flex overflow-y-hidden no-scollbar  w-full gap-3" style={{scrollbarWidth:"none"}}>
      ...
      {tvpage && tvsearch && (
        <>
          ...
          <div className="flex overflow-y-hidden no-scrollbar overflow-x-scroll w-full gap-3 " style={{scrollbarWidth:"none"}}>
            <div className="flex items-center space-x-4">
              {tvsearch.map((tv) => (
